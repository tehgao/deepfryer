...
setup(
    ...
    description="Discord deep fry bot",  # Optional
    ...
    # project.
    author="Alvin Gao",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="alvin@alvingao.com",  # Optional
    ...
    keywords="discord deepfry meme",  # Optional
